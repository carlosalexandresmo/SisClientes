...
namespace Unimed\ClienteBundle\Controller;
...
use Unimed\ClienteBundle\Entity\Cliente;
use Unimed\ClienteBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
     ...
     * @Method("POST")
     * @Template("UnimedClienteBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UnimedClienteBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UnimedClienteBundle:Cliente:edit.html.twig")
     */
